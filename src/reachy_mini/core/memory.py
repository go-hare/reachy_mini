...
class JsonlMemoryStore:
    ...
    def build_memory_view(self, conversation_id: str, agent_id: str, query: str, limit: int = 6) -> MemoryView:
        return MemoryView(
            ...
            projections={
                ...
                "soul_anchor": read_text(self.profile_root / "SOUL.md"),
                "front_anchor": read_text(self.profile_root / "FRONT.md"),
            },
        )
    ...
    def refresh_projections(self) -> None:
        ...
        if soul_updates:
            self._merge_projection_file(self.profile_root / "SOUL.md", "灵魂锚点", soul_updates)
