...
Reachy Mini still supports an app ecosystem powered by Hugging Face Spaces. This is optional. For the main local AI workflow in this repository, create an app project under `profiles/<name>/` and run it with the shared resident runtime described in AI Integrations.
...
* **Reachy Mini (Wireless):** Runs onboard (RPi CM4), autonomous, includes IMU. [See specs](./platforms/reachy_mini/hardware.md).
