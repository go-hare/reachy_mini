...
Reachy Mini still supports an app ecosystem powered by Hugging Face Spaces. This is optional. For the main local AI workflow in this repository, create an app project under `profiles/<name>/` and run it with the resident runtime described in AI Integrations.
