...
if (typeof document !== 'undefined') describe('ChatInterface new session control', () => {
  beforeEach(() => {
    vi.clearAllMocks()
    // @ts-ignore
  ...
  it('Cmd+Shift+N no longer triggers new chat', async () => {
    renderChat()
    ...
    // Fire the former global shortcut
